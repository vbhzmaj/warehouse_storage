...
<body>
	<div id = "wrap">
		<div id = "search">
			...
			<a href = "minus.php"><img src = "images/minus.png" height = "50px" title = "Decrease the quantity of an item."></a></br>
		</div>
		<div id = "search_display">
		<p>Increase will be performed only by valid entry: positive integers only with no empty spaces.</p>
		<?php
			...
			if(mysqli_num_rows($result) > 0){
				...
				?>
					<div id = "result">
						...
						<form action = "inc/increase.php" method = "GET">
							<label><b>Increase quantity for:</b> 
							<input type = "text" name = "increment" size = "6" maxlength = "6" placeholder = "Integer..."></label>
